...
module.exports = {
    ...
    async execute(message, args, client, config, colors, createYakuzaEmbed, emojis) {
        ...
        await performRoleplay('kiss', message.author, target, message, null, config, colors, createYakuzaEmbed, emojis);
    },
    
    async executeSlash(interaction, client, config, colors, createYakuzaEmbed, emojis) {
        const target = interaction.options.getUser('usuário');
        await performRoleplay('kiss', interaction.user, target, null, interaction, config, colors, createYakuzaEmbed, emojis);
    }
};
